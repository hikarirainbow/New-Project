...
LIGHTING: CanvasModulate Color(0.25, 0.18, 0.35) soft purple ambient darkness. Player PointLight2D 600px radial, cubic smoothstep interpolation, shadow enabled (PCF5 filter, shadow color 70% black).
